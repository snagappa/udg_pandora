...
kP = [[-99.0, -99.0], [-99.0, -99.0], [-99.0, -99.0], [-99.0,-99.0], [-99.0,-99.0]]
kV = [[-99.0, -99.0], [-99.0, -99.0], [-99.0, -99.0], [-99.0,-99.0], [-99.0,-99.0]]
...
# 4 1.0
kPmax = [[1.3,1.3], [1.3,1.3], [1.5,1.5],[1.5,5.0],[1.5,1.0]]
kPmin = [[1.0, 1.2], [1.0, 1.2], [1.2, 1.2],[1.0,2.0],[1.0,0.5]]
alpha = 1.0
...
dmp_1 = LearningDmpParametric(kP[3], kV[3], kPmin[3], kPmax[3],
                              ...
                              demonstrations,
                              init_time, end_time, param_value,
                              param_samples, export_filename[4])
dmp_1.trainningDMP()
dmp_1.exportPlayData()
