...
class VisualDetector(object):
    def __init__(self, name):
        ...
        self.detect_valves = rospy.get_param("visual_detector/detect_valves")
        ...
        # End effector camera
        self.use_endeffector = rospy.get_param("visual_detector/use_endeffector", False)
